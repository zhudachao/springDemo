...
public class PDFUtils {
	...
	public static void pdf2multiImage(String pdfFile, String outpath) {
		try {
			...
			for (int i = 0; i < actSize; i++) {
				BufferedImage image = new PDFRenderer(pdf).renderImageWithDPI(i, 320, ImageType.RGB);
				piclist.add(image);
			}
	...
	public static void main(String[] args) {
		pdfToImagePath("E:\\temp\\s1.pdf");
		pdfToImagePath("E:\\temp\\s2.pdf");
		pdfToImagePath("E:\\temp\\w2.pdf");
		pdfToImagePath("E:\\temp\\w3.pdf");
//		pdf2multiImage("C:\\Users\\Wangjun\\Desktop\\发票.pdf", "F:\\Wangjun\\111.jpg");
	}
